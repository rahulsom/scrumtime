...
<html>
    ...
    <body>
        ...
        <div id="edit-music" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.music}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.music}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.music}" method="PUT">
                <g:hiddenField name="version" value="${this.music?.version}" />
                <fieldset class="form">
                    <f:all bean="music"/>
                </fieldset>
